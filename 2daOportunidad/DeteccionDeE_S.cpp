...
int main()
{
	Mat img, img1, hsv, binary;
	Mat img2(100, 100, CV_8UC3, Scalar::all(0));

	int c = 0;
	int INx, INy;    // Coordenadas de la Entrada
	int OUTx,OUTy;	 // coodenadas de la Salida
...
void GraficadorCubos(void)
{
	Mat drawing;
	drawing = Mat::zeros(Size(200, 200), CV_8UC1);
